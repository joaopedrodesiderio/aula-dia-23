...
function validarNome(){
    try {
        ...
        if(re.test(nome)){
            //se o campo for invalido, retorna false para o formulário nao ser enviado
            alert('Nome inválido')
...
function gerar_json(form){
    ...
    var dados = {nome, cpf, telefone_res, telefone_cel, cep,
    ...
    if(formularioValido){
        ...
        alert ("Preencha todos campos de forma correta, não deixe nenhum campo sem preenchimento!");
        document.form.focus ();
    }
}
...
$(function(){
    ...
    $(".tel_cel_mask").mask('(99)9999-9999');
